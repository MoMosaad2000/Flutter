...
class News_technology extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return News_technology_state();
  }
}
class News_technology_state extends State<News_technology>{

  @override
  Widget build(BuildContext context) {
    var s = context.read<NewsBloc>().add(FetchNews('Technology'));
