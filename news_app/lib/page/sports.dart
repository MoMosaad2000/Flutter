...
class News_sports extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return News_sports_state();
  }
}
class News_sports_state extends State<News_sports>{

  @override
  Widget build(BuildContext context) {
    var s = context.read<NewsBloc>().add(FetchNews('Sports'));
