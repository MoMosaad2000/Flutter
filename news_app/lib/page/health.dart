...
class News_health extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return News_health_state();
  }
}
class News_health_state extends State<News_health>{

  @override
  Widget build(BuildContext context) {
    var s = context.read<NewsBloc>().add(FetchNews('Health'));
