...
class News_Business extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return News_Business_state();
  }
}

class News_Business_state extends State<News_Business> {

  @override
  Widget build(BuildContext context) {
    var s = context.read<NewsBloc>().add(FetchNews('Business'));
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    '${state.response?.articles![0].urlToImage}',
                                    height: 180,
